package com.javaoffers.tess4f.ocr.utils;
...
public class HttpClientUtils  {
	 ...
	 * @throws Exception
	 */
	public static HttpEntity postBytesFileOfAOS(String url,Map<String,Object> urlParam, byte[] file ,String fileName, Map<String,String> headers) throws Exception {
		return postBytesFile(url,urlParam,file,fileName,headers,ContentType.APPLICATION_OCTET_STREAM);

	}

	/**
	 * 上传文件  MULTIPART_FORM_DATA
	 * @param url
	 * @param urlParam
	 * @param file
	 * @param fileName
	 ...
	 * @throws Exception
	 */
	public static HttpEntity postBytesFileOfMFD(String url,Map<String,Object> urlParam, byte[] file ,String fileName, Map<String,String> headers) throws Exception {
		return postBytesFile(url,urlParam,file,fileName,headers,ContentType.MULTIPART_FORM_DATA);
	}

	public static HttpEntity postBytesFile(String url,Map<String,Object> urlParam, byte[] file ,String fileName, Map<String,String> headers,ContentType contentType) throws Exception {
		HttpPost httpPost = new HttpPost(url);
		MultipartEntityBuilder multipartEntityBuilder = MultipartEntityBuilder.create();
		multipartEntityBuilder.addBinaryBody("file", file, contentType, fileName);
		HttpEntity httpEntity = multipartEntityBuilder.build();
		return requestMethodsHttpEntry(httpPost,urlParam,httpEntity,headers);
	}
	/**
	 * 自定义request方法请求,body为字节类型
	 *
	...
	public static String postXML(String url, String xml)throws Exception {
		...
		HttpPost httpPost = new HttpPost(url);
		Map<String, String> headers = MapUtils.startBuildParam("Content-Type", "text/xml; charset=UTF-8").endBuildStringParam();
	 ...
	 * @return
	 */
	public static String postData(String targetUrl, Map<String, Object> bodyParam) throws Exception {
	 ...
	 * @return
	 */
	public static String postData(String targetUrl, Map<String,Object> urlParams,Map<String, Object> bodyParam, Map<String, String> headers) throws Exception {
		HttpPost httpPost = new HttpPost(targetUrl);
		headers.put("Content-Type", "application/json");
		return requestMethodsHttpData(httpPost, urlParams, JSON.toJSONString(bodyParam), headers);
	}
	...
	public static String postParamData(String targetUrl,Map<String, Object> bodyParam, Map<String, String> headers) throws Exception {
		HttpPost httpPost = new HttpPost(targetUrl);
		Map headers_ = MapUtils.startBuildParam("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8").endBuildStringParam();
